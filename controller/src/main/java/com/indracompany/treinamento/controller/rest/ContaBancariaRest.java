...
public class ContaBancariaRest extends GenericCrudRest<ContaBancaria, Long, ContaBancariaService>{
	...
	public @ResponseBody ResponseEntity<Void> transferencia(@RequestBody SaqueDTO dto){
	...
	public @ResponseBody ResponseEntity<List<OperacaoDTO>> extratoContaPorData(@PathVariable String inicio, @PathVariable String fim, @PathVariable String agencia, @PathVariable String numeroConta) {

		List<OperacaoDTO> operacoes = contaBancariaService.getExtratoPorDataHora(agencia, numeroConta, inicio, fim);
